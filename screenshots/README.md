...
<img width="500"  alt="The Wireshark Network Analyzer" src="https://github.com/user-attachments/assets/e1a3a4ee-e1a0-42ff-8209-203e87a6c3ed" />

## Phase 2: Traffic Analysis 
### Traffic Generation
<img width="500" alt="Pasted Graphic 3" src="https://github.com/user-attachments/assets/d7e2cb2a-4587-455a-9bfe-78be32c355ba" />

### Packet Capture
<img width="500" alt="0000 = Fragment Offset 0" src="https://github.com/user-attachments/assets/d86b4d61-fdb2-4b1a-b944-e2c5493d5ec9" />

## Phase 3: Security Audit with Lynis 
### Lynis Audit Execution
<img width="500"  alt="To the let to to det at wing the o are not o" src="https://github.com/user-attachments/assets/a218ade9-470e-4ae3-b6e5-1be54ae9fd5c" />

### Lynis Audit Results
<img width="500"  alt="Lynis security scan details" src="https://github.com/user-attachments/assets/f73e5c6b-2f85-4cc6-9622-112972b8dde6" />

## Phase 4: Vulnerability Assessment
### Nmap Installation 
<img width="500" alt="rishe tening packages were sutorrtha net-flin" src="https://github.com/user-attachments/assets/bd236c2e-ba90-4b50-a34b-ea8a8f4a689b" />

### Nmap scan execution/results 
<img width="500" alt="prishithaßprishitha-QEMU-Virtual-Machine~linux-security-lab$ nnap" src="https://github.com/user-attachments/assets/56b52648-16a0-4ee1-a90c-0aa1a75883d3" />

## Phase 5: Authentication log Review 
### Log analysis 
<img width="500"  alt="Screenshot 2026-05-28 at 12 20 37 PM" src="https://github.com/user-attachments/assets/90b2712c-d1ba-44e9-80d6-947414bf003d" />
